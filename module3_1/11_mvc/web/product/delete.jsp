...
<form action="/products?action=delete&id=${requestScope["product"].getId()}" method="post">
    <fieldset>
        ...
        <table>
            <tr>
                <td>Product Name</td>
                <td><input disabled type="text" name="name" id="name"
                           value="${requestScope["product"].getProductName()}"></td>
            </tr>
            <tr>
                <td>Product Price</td>
                <td><input disabled type="text" name="price" id="price"
                           value="${requestScope["product"].getProductPrice()}"></td>
            </tr>
            <tr>
                <td>Product Description</td>
                <td><input disabled type="text" name="description" id="description"
                           value="${requestScope["product"].getProductDescription()}"></td>
            </tr>
            <tr>
                <td>Producer</td>
                <td><input disabled type="text" name="producer" id="producer"
                           value="${requestScope["product"].getProducer()}"></td>
            </tr>
            <tr>
                <td>
