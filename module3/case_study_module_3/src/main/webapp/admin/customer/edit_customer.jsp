...
<div align="center">
    <form action="/admin/customer?action=edit&id=${customer.getCustomerId()}" method="post">
        <table border="1" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <select name="gender" class="form-control" id="gender">
                        <option hidden
                                value="${customer.getCustomerGender()}">${customer.getCustomerGender()?'Nam':'Nữ'}</option>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <a class="btn btn-success" href="/admin/customer">Back</a>
                </td>
            </tr>
        </table>
    </form>
