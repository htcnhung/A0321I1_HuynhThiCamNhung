...
public class CustomerRepository {
    ...
    private static final String INSERT_CUSTOMER_SQL = "INSERT INTO customer" + "  (customer_id,customer_type_id, customer_name, customer_birthday," +
            " customer_gender, customer_id_card, customer_phone, customer_mail, customer_address) VALUES " +
            " (?,?, ?, ?,?,?,?,?,?);";
    ...
    private static final String SELECT_CUSTOMER_BY_ID = "select customer_type_id, customer_name, customer_birthday, " +
            "customer_gender, customer_id_card, customer_phone, customer_mail, customer_address from customer where customer_id =?";
    ...
    private static final String UPDATE_CUSTOMER_SQL = "update customer set customer_type_id = ?, customer_name = ?, customer_birthday = ?, " +
            "customer_gender = ?, customer_id_card = ?, customer_phone = ?, customer_mail = ?, customer_address = ? where customer_id = ?";
...
//                String birthday1 = dt1.format(date);
                ...
                String customerEmail = rs.getString("customer_mail");
    ...
    public Customer selectCustomer1(String id) {
        ...
        try (Connection connection = MySQLConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                String customerEmail = rs.getString("customer_mail");
                String customerAddress = rs.getString("customer_address");
                customer = new Customer(id, customerType, customerName, birthday1, customerGender,
                        customerCardId, customerPhone, customerEmail, customerAddress);
            }
        } catch (SQLException e) {
            printSQLException(e);
    ...
    public List<Customer> selectAllCustomer() {
        ...
        try (Connection connection = MySQLConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                customers.add(new Customer(id, customerType, customerName, birthday1, customerGender,
                        customerCardId, customerPhone, customerEmail, customerAddress));
            }
        } catch (SQLException e) {
            printSQLException(e);
    ...
    public List<Customer> selectCustomerByName(String name) {
        ...
        try (
            ...
            while (rs.next()){
                ...
                String customerEmail = rs.getString("customer_mail");
                String customerAddress = rs.getString("customer_address");
                customerList.add(new Customer(id, customerType, customerName, birthday1, customerGender,
                        customerCardId, customerPhone, customerEmail, customerAddress));
            }
