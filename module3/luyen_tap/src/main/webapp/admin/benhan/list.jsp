    ...
    <table id="tableCustomer" class="table table-striped table-bordered">
        ...
        <c:forEach var="benhAn" items="${benhAns}">
            <tr>
                ...
                <td><c:out value="${benhAn.getTenBenhNhan()}"/></td>
                ...
                <td style="text-align: center">
                    ...
                    <a style="color: white" class="btn btn-danger"
                       ...
                       onclick="benhAnSetId('${benhAn.getIdBenhAn()}')"
...
<script>
    ...
    function benhAnSetId(id) {
        ...
        document.getElementById("modelId").value = "Bạn có muốn xóa bệnh án này không?: " + id;
    }
</script>
</body>
</html>
